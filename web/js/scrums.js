...
//    hide_visibility('save_footer');
	...
	var URL = "http://localhost/pmosandbox/page.cgi?id=scrums/release_ajax.html";
...
//    hide_visibility('save_footer');
	...
	var URL = "http://localhost/pmosandbox/page.cgi?id=scrums/release_ajax.html&action=orderteambugs";
/*
        // Start creating the XML
        var xmlBody = "<bug_list>";
	var box1 = document.getElementById("tble1");
