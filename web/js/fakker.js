...
function init(schema, obj_id, lists)
{
    ...
    $.post('page.cgi?id=scrums/ajax.html', {schema: schema, action: 'fetch', obj_id: obj_id}, call_back, 'json');
    //update_lists(ordered_bugs);
...
function save(lists, schema, obj_id, data_lists)
{
    ...
    $.post('page.cgi?id=scrums/ajax.html', {schema: schema, action: 'set', obj_id: obj_id, data: data_lists}, function () {}, 'json');
}
