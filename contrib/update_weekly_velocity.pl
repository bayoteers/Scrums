...
sub _create_time_span {
    @array = localtime();
    my $localtime_day = $array[3];
    my $localtime_month = $array[4];
    my $localtime_year = $array[5];

    my $today = DateTime->new( year  => $localtime_year+1900,
...
#      print "Monday: ", $monday_day, ".", $monday_month, ".",  $monday_year, "\n";
    ...
    my $monday = DateTime->new( year  => $monday_year,
                          month => $monday_month,
                          day   => $monday_day,
                          );
